...
public class Telefonia {
    ...
    public void cadastrarAssinante() {
        ...
        if (tipoAssinante == 1) {
            if (numPrePagos < prePagos.length) {
                prePagos[numPrePagos] = new PrePago(String.valueOf(cpf), nome, numero, 100, 100);
                numPrePagos++;
            ...
            if (numPosPagos < posPagos.length) {
                ...
                posPagos[numPosPagos] = new PosPago(String.valueOf(cpf), nome, numero, assinatura, 100);
                numPosPagos++;
    ...
    public void fazerChamada() {
        ...
        if (tipoAssinante == 1) {
            ...
            if (assinantePrePago != null) {
                ...
                assinantePrePago.fazerChamada(duracao);
            ...
            if (assinantePosPago != null) {
                ...
                assinantePosPago.fazerChamada(duracao);
                chamadaRealizada = true;
            }
        }
    ...
    public void fazerRecarga() {
        ...
        if (assinantePrePago != null) {
            ...
            assinantePrePago.recarregar(valor);
    ...
    private PrePago localizarPrePago(long cpf) {
        for (int i = 0; i < numPrePagos; i++) {
            if (Long.parseLong(prePagos[i].getCpf()) == cpf) {
                return prePagos[i];
            }
        }
        return null;
    ...
    private PosPago localizarPosPago(long cpf) {
        for (int i = 0; i < numPosPagos; i++) {
            if (Long.parseLong(posPagos[i].getCpf()) == cpf) {
                return posPagos[i];
            }
        }
        return null;
